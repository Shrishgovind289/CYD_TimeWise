...
Weather information was retrieved using:
...
They are then converted from PNG into raw **RGB565 `.BIN` files** using:
...
Music is streamed from a **Navidrome server**.
